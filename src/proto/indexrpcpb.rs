...
impl<'a> ::std::default::Default for &'a StatusResp {
    fn default() -> &'a StatusResp {
        <StatusResp as ::protobuf::Message>::default_instance()
    }
}

impl StatusResp {
    pub fn new() -> StatusResp {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for StatusResp {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<StatusResp>(
                    "StatusResp",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static StatusResp {
        static mut instance: ::protobuf::lazy::Lazy<StatusResp> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const StatusResp,
        };
        unsafe {
            instance.get(StatusResp::new)
        }
    }
}

impl ::protobuf::Clear for StatusResp {
    fn clear(&mut self) {
        self.value.clear();
        self.err = RespErr::OK;
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for StatusResp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for StatusResp {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
impl ::protobuf::ProtobufEnum for ReqType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<ReqType> {
        match value {
            ...
            6 => ::std::option::Option::Some(ReqType::Status),
            _ => ::std::option::Option::None
        }
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ue\x18\x01\x20\x01(\tR\x05value\x12%\n\x03err\x18\x02\x20\x01(\x0e2\x13.\
    indexrpcpb.RespErrR\x03err\"F\n\x07GetResp\x12\x14\n\x05value\x18\x01\
    \x20\x01(\tR\x05value\x12%\n\x03err\x18\x02\x20\x01(\x0e2\x13.indexrpcpb\
    .RespErrR\x03err\"0\n\x07PutResp\x12%\n\x03err\x18\x01\x20\x01(\x0e2\x13\
    .indexrpcpb.RespErrR\x03err\"3\n\nDeleteResp\x12%\n\x03err\x18\x01\x20\
    \x01(\x0e2\x13.indexrpcpb.RespErrR\x03err\"I\n\nSearchResp\x12\x14\n\x05\
    value\x18\x01\x20\x01(\tR\x05value\x12%\n\x03err\x18\x02\x20\x01(\x0e2\
    \x13.indexrpcpb.RespErrR\x03err\"1\n\x08RaftDone\x12%\n\x03err\x18\x01\
    \x20\x01(\x0e2\x13.indexrpcpb.RespErrR\x03err*3\n\x07RespErr\x12\x06\n\
    ...
    \x04\x02\x02\x01\x01\x12\x03(\x0c\x0f\n\x0c\n\x05\x04\x02\x02\x01\x03\
    ...
    \x04\x06\x02\x01\x01\x12\x03:\x0c\x0f\n\x0c\n\x05\x04\x06\x02\x01\x03\
    ...
    \x05\x04\x07\x02\0\x03\x12\x03>\x12\x13b\x06proto3\
";
